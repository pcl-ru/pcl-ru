...
песни из него, или изменять порядок проигрывания путем сортировки и перемешивания.
...
вы также получаете строку \code{User-Agent} из объекта \code{request}, и сохраняете ее в
...
песен. Метод \code{current-song} уже имеет эту функциональность: путем определения
...
Функция \code{reset-current-song} использует еще один прием: поскольку вы хотите чтобы
