...
% \setfnpct{punct-after=true}
% \setfnpct{add-punct-marks={:.,!?}[-0.8em][-0.8em]}
% \setfnpct{before-punct-space=-0.08em}
% \setfnpct{before-dot-space=-0.5em}
% \setfnpct{before-comma-space=-0.5em}
% \setfnpct{after-punct-space=-0.08em}
% \setfnpct{after-dot-space=-0.5em}
% \setfnpct{after-comma-space=-0.5em}
