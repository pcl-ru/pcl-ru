...
% 70х100/16 -> 170mmх240mm
 \usepackage[papersize={165mm,235mm},asymmetric,% bindingoffset=5mm,
hmargin={3cm,2cm},vmargin={1.25cm,2.5cm},includehead,ignorefoot,heightrounded,headsep=12bp,headheight=12.5bp,footnotesep=10bp plus2bp minus2bp]{geometry}
...
%\lstset{literate={->}{{$\to$}{}}2 {=>}{{${\Rightarrow}$}}2 {|>}{{\makebox[.5em][l]{$\triangleright{}$} }}1}
